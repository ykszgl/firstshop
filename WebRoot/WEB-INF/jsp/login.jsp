...
<div class="container header">
	<div class="span5">
		<div class="logo">
			<img src="${pageContext.request.contextPath}/image/logo/zgl.png" />
		</div>
	</div>
	<div class="span9">
<div class="headerAd">
...
<div class="ad">
		...
		<div class="span12 last">
			<div class="wrap">
				...
				style="display: list-item;"><a href="${pageContext.request.contextPath}/user_registPage.action">立即注册</a>|
			</li>
										</dd>
									</dl>
								</td>
